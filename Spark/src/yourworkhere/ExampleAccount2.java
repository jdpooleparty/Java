...
public class ExampleAccount2 {
	...
	public static void main(String[] args) {
		...
		double withdrawalAmount = 50002.21;
		double depositAmount = -40020.02;
		...
		boolean invalidDeposit = depositAmount <= 0;
				System.out.println(invalidDeposit);
